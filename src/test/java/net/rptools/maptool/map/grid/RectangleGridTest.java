    ...
    for (int i = 0; i < 5; i++) {
      ...
      for (double x = 0; x < width * 5; x += width) {
        for (double y = 0; y < height * 5; y += height) {
          // point on the top left most boundary and points just inside either boundary should
          // result in same center
    ...
    for (int i = 0; i < 5; i++) {
      ...
      for (double x = 0; x < width * 5; x += width) {
        for (double y = 0; y < height * 5; y += height) {
          // point on the top left most boundary and points just inside either boundary should
          // result in same center
          // have to add tiny amount as FP numbers cant represent every number and the boundary some
          // times presents rounding issues.
          ...
          assertEquals(
              expected.getX(), c1.getX(), 0.001, "X Point inside left boundary doesn't match");
          assertEquals(
              expected.getY(), c1.getY(), 0.001, "Y Point inside left boundary doesn't match");
          assertEquals(
              expected.getX(), c2.getX(), 0.001, "X Point inside right boundary doesn't match");
          assertEquals(
              expected.getY(), c2.getY(), 0.001, "Y Point inside right boundary doesn't match");
        }
      }
    }
  }
    ...
    for (int i = 0; i < 5; i++) {
      ...
      for (double x = 0; x < width * 5; x += width) {
        for (double y = 0; y < height * 5; y += height) {
          ...
          Rectangle2D expected = new Rectangle2D(x, y + height, width, height);
          assertEquals(
              expected.getMinX(), b0.getMinX(), 0.001, "Min X Point on boundary doesn't match");
          assertEquals(
              expected.getMaxX(), b0.getMaxX(), 0.001, "Max X Point on boundary doesn't match");
          assertEquals(
              expected.getMinY(), b0.getMinY(), 0.001, "Min Y Point on boundary doesn't match");
          assertEquals(
              expected.getMaxY(), b0.getMaxY(), 0.001, "Max Y Point on boundary doesn't match");
          assertEquals(
              expected.getMinX(),
              b1.getMinX(),
              0.001,
              "Min X Point inside left boundary doesn't match");
          assertEquals(
              expected.getMaxX(),
              b1.getMaxX(),
              0.001,
              "Max X Point inside left boundary doesn't match");
          assertEquals(
              expected.getMinY(),
              b1.getMinY(),
              0.001,
              "Min Y Point inside left boundary doesn't match");
          assertEquals(
              expected.getMaxY(),
              b1.getMaxY(),
              0.001,
              "Max Y Point inside left boundary doesn't match");
          assertEquals(
              expected.getMinX(),
              b2.getMinX(),
              0.001,
              "Min X Point inside right boundary doesn't match");
          assertEquals(
              expected.getMaxX(),
              b2.getMaxX(),
              0.001,
              "Max X Point inside right boundary doesn't match");
          assertEquals(
              expected.getMinY(),
              b2.getMinY(),
              0.001,
              "Min Y Point inside right boundary doesn't match");
          assertEquals(
              expected.getMaxY(),
              b2.getMaxY(),
              0.001,
              "Max Y Point inside right boundary doesn't match");
        }
      }
    }
  }
