...
public class VisibleArea {
   ...
   */
  public VisibleArea(Collection<MPolygon> polys, Collection<MLineSegment> visionRays, Collection<Point2D> vert) {
  ...
  /**
   * Returns the "rays" from the viewer towards the vertices of the vision blocking polygons.
   * These values are really only useful for debugging purposes.
   *
  ...
  /**
   * Returns the vertices for the vision blocking polygons.
   * These values are really only useful for debugging purposes.
   *
